          ...
          <div key={player.id} className="flex items-center gap-3 w-full px-1">
            ...
            {isPlayerDefender ? (
              <div className="flex items-center gap-2 flex-1">
                <span className="text-xs" style={{ color: '#2A6A8A' }}>
                  Defender
                </span>
                ...
                <span
                  ...
                  style={{ color: shotDown >= 4 ? '#00C8FF' : '#2A5060' }}
                >
                  {shotDown}/6
                </span>
              </div>
              ...
              <div className="flex items-center gap-2 flex-1">
                <span className="text-xs" style={{ color: '#1A4A1A' }}>
                  Invaders
                </span>
                <div className="flex gap-1">
                  {Array.from({ length: 6 }, (_, i) => (
                ...
                <span
                  className="text-xs font-mono"
                  style={{ color: remaining <= 2 ? '#39FF14' : '#1A4A1A' }}
                >
                  {remaining}/6
                </span>
              </div>
